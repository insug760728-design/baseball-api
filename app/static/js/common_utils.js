...
const CommonUtils = (() => {
  const _SHORT_TEAM_NAMES = {
    ...
    '요코하마 DeNA 베이스타즈': '요코하마', '요코하마 DeNA': '요코하마', 'DeNA 베이스타즈': '요코하마', '요코하마': '요코하마', 'DeNA': '요코하마',
    '히로시마 도요 카프': '히로시마', '히로시마 도요카프': '히로시마',
    '후쿠오카 소프트뱅크 호크스': '소프트뱅크', '소프트뱅크 호크스': '소프트뱅크',
    '지바 롯데 마린스': '지바', '지바롯데 마린스': '지바', '지바 롯데': '지바', '지바롯데': '지바', '치바 롯데 마린스': '지바', '치바 롯데': '지바', '치바롯데': '지바', '지바': '지바',
    '도호쿠 라쿠텐 골든이글스': '라쿠텐', '라쿠텐 골든이글스': '라쿠텐',
    '오릭스 버펄로스': '오릭스', '오릭스 버팔로스': '오릭스',
    '사이타마 세이부 라이온즈': '세이부', '세이부 라이온즈': '세이부',
    '홋카이도 닛폰햄 파이터즈': '닛폰햄', '닛폰햄 파이터즈': '닛폰햄', '홋카이도 닛폰햄 파이터스': '닛폰햄', '닛폰햄 파이터스': '닛폰햄', '니혼햄': '닛폰햄', '닛폰햄': '닛폰햄',
