...
FULL_NAMES = {
    ...
    "Ben Rice": "벤 라이스", "George Lombard Jr.": "조지 롬바드 Jr.", "George Lombard": "조지 롬바드",
    "Mason Englert": "메이슨 엥글러트", "Jonny DeLuca": "조니 델루카", "Junior Caminero": "주니어 카미네로",
    "Richie Palacios": "리치 팔라시오스", "Ryan Bliss": "라이언 블리스", "Cedric Mullins": "세드릭 멀린스",
    "Jorge Mateo": "호르헤 마테오", "Jonathan Aranda": "조나단 아란다", "Ali Sanchez": "알리 산체스",
    "Ali Sánchez": "알리 산체스", "Jose Caballero": "호세 카바예로", "José Caballero": "호세 카바예로",
    "Victor Mesa Jr.": "빅터 메사 Jr.", "Ryan McMahon": "라이언 맥맨", "Spencer Jones": "스펜서 존스",
    "Jazz Chisholm Jr.": "재즈 치좀 Jr.", "Jazz Chisholm": "재즈 치좀", "Parker Meadows": "파커 메도우스",
    "Kerry Carpenter": "케리 카펜터", "Colt Keith": "콜트 키스", "Wenceel Perez": "웬실 페레즈",
    "Wenceel Pérez": "웬실 페레즈", "Spencer Torkelson": "스펜서 토켈슨", "Zach McKinstry": "잭 맥킨스트리",
    "Trey Sweeney": "트레이 스위니", "Jake Rogers": "제이크 로저스", "Yandy Diaz": "얀디 디아즈",
    "Yandy Díaz": "얀디 디아즈", "Brandon Lowe": "브랜든 로우", "Christopher Morel": "크리스토퍼 모렐",
    "Ben Rortvedt": "벤 로트베트", "Jose Siri": "호세 시리", "José Siri": "호세 시리",
    "Taylor Walls": "테일러 월스", "Justyn-Henry Malloy": "저스틴-헨리 말로이",
    ...
    "深沢 鳳介": "후카자와 호스케", "深沢鳳介": "후카자와 호스케", "深沢": "후카자와 호스케",
    "荘司 康誠": "쇼지 코세이", "荘司康誠": "쇼지 코세이", "荘司": "쇼지 코세이",
    "奥川 恭伸": "오쿠가와 야스노부", "奥川恭伸": "오쿠가와 야스노부", "Okugawa Yasunobu": "오쿠가와 야스노부", "奥川": "오쿠가와 야스노부",
    "髙橋 遥人": "다카하시 하루토", "髙橋遥人": "다카하시 하루토", "高橋 遥人": "다카하시 하루토", "高橋遥人": "다카하시 하루토", "髙橋": "다카하시 하루토", "高橋": "다카하시 하루토",
    "上沢 直之": "우와사와 나오유키", "上沢直之": "우와사와 나오유키", "上沢": "우와사와 나오유키",
    "武内 夏暉": "타케우치 나츠키", "武内夏暉": "타케우치 나츠키", "武内": "타케우치 나츠키",
    "ルケーシー": "조이 루케시", "ジョーイ・ルケーシー": "조이 루케시",
    "九里 亜蓮": "쿠리 아렌", "九里亜蓮": "쿠리 아렌", "Kuri Aren": "쿠리 아렌", "Aren Kuri": "쿠리 아렌", "九里": "쿠리 아렌",
    "達 孝太": "타츠 코타", "達孝太": "타츠 코타", "達": "타츠 코타",
    ...
    "床田 寛樹": "토코다 히로키", "床田寛樹": "토코다 히로키", "Tokoda Hiroki": "토코다 히로키", "Hiroki Tokoda": "토코다 히로키", "床田": "토코다 히로키",
    "田中 晴也": "타나카 세이야", "田中晴也": "타나카 세이야", "Tanaka Seiya": "타나카 세이야",
    "前田 健太": "마에다 켄타", "前田健太": "마에다 켄타", "Maeda Kenta": "마에다 켄타", "Kenta Maeda": "마에다 켄타", "前田": "마에다 켄타",
    ...
    "山野 太一": "야마노 타이치", "山野太一": "야마노 타이치", "Yamano Taichi": "야마노 타이치",
    ...
    "ビシエド": "다얀 비시에도", "D.ビシエド": "다얀 비시에도", "カリステ": "올란도 칼리스테", "ロドリ게스": "로드리게스", "ロドリゲス": "로드리게스",
    ...
    "ルケーシー": "루케시", "J.ルケーシー": "조이 루케시", "サノー": "미겔 사노", "キャベッジ": "트레이 캐비지",
    "ダルベック": "바비 달벡", "マッカスカー": "매커스커", "カナリオ": "알렉산더 카나리오", "ネビン": "타일러 네빈",
    "レイエス": "프란밀 레이에스", "カストロ": "로드포 카스트로", "オコエ": "오코에 루이", "オコエ瑠偉": "오코에 루이",
    "上茶谷 大河": "카미차타니 다이가", "上茶谷大河": "카미차타니 다이가", "上茶谷": "카미차타니",
    "西川 龍馬": "니시카와 료마", "近藤 健介": "콘도 켄스케", "岡本 和真": "오카모토 카즈마",
    "村上 宗隆": "무라카미 무네타카", "牧 秀悟": "마키 슈고", "万波 中正": "만나미 츄세이",
    "細川 成也": "호소카와 세이야", "清宮 幸太郎": "키요미야 코타로", "坂本 勇人": "사카모토 하야토",
    "大谷 翔平": "오타니 쇼헤이", "大谷翔平": "오타니 쇼헤이", "山本 由伸": "야마모토 요시노부", "山本由伸": "야마모토 요시노부",
    "今永 昇太": "이마나가 쇼타", "今永昇太": "이마나가 쇼타", "千賀 滉大": "센가 코다이", "千賀滉大": "센가 코다이",
    "達 孝太": "타츠 코타", "達孝太": "타츠 코타", "佐々木 朗希": "사사키 로키", "佐々木朗希": "사사키 로키",
    "ダルビッシュ 有": "다르빗슈 유", "ダルビッシュ有": "다르빗슈 유",
    "ターノック": "터녹", "竹田 祐": "다케다 유", "竹田祐": "다케다 유", "竹田": "다케다",
    "宮﨑 敏郎": "미야자키 토시로", "宮﨑敏郎": "미야자키 토시로", "宮﨑": "미야자키", "宮崎 敏郎": "미야자키 토시로", "宮崎敏郎": "미야자키 토시로",
    "辰己 涼介": "타츠미 료스케", "辰己涼介": "타츠미 료스케", "辰己": "타츠미",
    "坂本 勇": "사카모토 하야토", "坂本勇": "사카모토 하야토",
    "清宮 幸": "키요미야 코타로", "清宮幸": "키요미야 코타로",
    "丸山 和": "마루야마 카즈야", "丸山和": "마루야마 카즈야",
    "増田 陸": "마스다 리쿠", "増田陸": "마스다 리쿠",
    "牧原 大": "마키하라 다이세이", "牧原大": "마키하라 다이세이",
    "다카하시 宏": "다카하시 히로토", "高橋 宏": "다카하시 히로토", "高橋宏": "다카하시 히로토", "髙橋 宏": "다카하시 히로토", "髙橋宏": "다카하시 히로토",
    "이시카와 昂": "이시카와 타카야", "石川 昂": "이시카와 타카야", "石川昂": "이시카와 타카야", "石川 昂弥": "이시카와 타카야",
    "스즈키 叶": "스즈키 쿄시로", "鈴木 叶": "스즈키 쿄시로", "鈴木叶": "스즈키 쿄시로",
    "야나기 田": "야나기타 유키", "柳 田": "야나기타 유키", "柳田": "야나기타 유키", "柳田 悠岐": "야나기타 유키", "柳田悠岐": "야나기타 유키",
    "이노우에 朋": "이노우에 토모야", "井上 朋": "이노우에 토모야", "井上朋": "이노우에 토모야",
    "이노우에 絢": "이노우에 켄타", "井上 絢": "이노우에 켄타", "井上絢": "이노우에 켄타",
    "마츠모토 健": "마츠모토 켄고", "松本 健": "마츠모토 켄고", "松本健": "마츠모토 켄고",
    "니시 川": "니시카와 료마", "西 川": "니시카와 료마", "西川": "니시카와 료마",
    "니시 村": "니시무라", "西 村": "니시무라", "西村": "니시무라",
    "니시 野": "니시노", "西 野": "니시노", "西野": "니시노",
...
NPB_FAMILY_NAME_MAP = {
    ...
    "上原": "우에하라", "山下": "야마시타", "東浜": "히가시하마", "西川": "니시카와", "近藤": "콘도",
    "岡本": "오카모토", "牧": "마키", "万波": "만나미", "細川": "호소카와", "清宮": "키요미야",
    "坂本": "사카모토", "丸": "마루", "長野": "초노", "吉川": "요시카와", "門脇": "카도와키",
    "三森": "미모리", "中山": "나카야마", "中島": "나카지마", "中川": "나카가와", "中川虎": "나카가와 토라",
    "丸山": "마루야마", "今川": "이마가와", "佐々木": "사사키", "佐野": "사노", "内山": "우치야마",
    "古市": "후루이치", "吉田": "요시다", "吉野": "요시노", "周東": "슈토", "増田": "마스다",
    "大城": "오오시로", "大塚": "오오츠카", "太田": "오오타", "奈良間": "나라마", "安田": "야스다",
    "宗": "무네", "宗山": "무네야마", "宮下": "미야시타", "宮本": "미야모토", "寺地": "테라치",
    "小川": "오가와", "小深田": "코부카타", "小郷": "오고", "山中": "야마나카", "山川": "야마카와",
    "岡林": "오카바야시", "岩田": "이와타", "川村": "카와무라", "川瀬": "카와세", "度会": "와타라이",
    "村松": "무라마츠", "村林": "무라바야시", "来田": "키타", "林": "하야시", "柘植": "츠게",
    "栗原": "쿠리하라", "正木": "마사키", "武岡": "타케오카", "水谷": "미즈타니", "水野": "미즈노",
    "池田": "이케다", "泉口": "이즈미구치", "浦田": "우라타", "海野": "우미노", "渡部": "와타나베",
    "源田": "겐다", "滝澤": "타키자와", "牧原": "마키하라", "田宮": "타미야", "石伊": "이시이",
    "福元": "후쿠모토", "福永": "후쿠나가", "筒香": "츠츠고", "紅林": "쿠레바야시", "花田": "하나다",
    "若月": "와카츠키", "藤原": "후지와라", "蛭間": "히루마", "蝦名": "에비나", "赤羽": "아카하네",
...
NPB_GIVEN_NAME_MAP = {
    "礼亜": "레이아", "勇陽": "유히", "和幸": "카즈키", "康誠": "코세이", "暢仁": "마사토", "孝太": "코타",
...
def katakana_to_hangul(text: str) -> str:
    """Algorithmic Japanese Katakana/Hiragana to Korean Hangul transliterator."""
    if not text:
        return ""
    ...
    def attach_jong(char_str: str, jong_char: str) -> str:
        if not char_str or len(char_str) != 1: return char_str + jong_char
        code = ord(char_str)
        if 0xAC00 <= code <= 0xD7A3:
            syl_idx = code - 0xAC00
            jong_idx = syl_idx % 28
            if jong_idx == 0 and jong_char in JONG:
                return chr(code + JONG.index(jong_char))
        return char_str + jong_char

    res = []
    i = 0
    n = len(text)
    while i < n:
        if i + 1 < n and text[i:i+2] in DIGRAPHS:
            res.append(DIGRAPHS[text[i:i+2]])
            i += 2
        elif text[i] == 'ン':
            if res and len(res[-1]) == 1 and 0xAC00 <= ord(res[-1]) <= 0xD7A3 and (ord(res[-1]) - 0xAC00) % 28 == 0:
                res[-1] = attach_jong(res[-1], 'ㄴ')
            else:
                res.append('엔' if not res else 'ㄴ')
            i += 1
        elif text[i] == 'ッ':
            if i + 1 < n:
                next_c = text[i+1]
                batchim = 'ㄱ' if next_c in 'カキクケコガギグゲゴ' else ('ㅂ' if next_c in 'パピプペポバビブベボ' else 'ㅅ')
                if res and len(res[-1]) == 1 and 0xAC00 <= ord(res[-1]) <= 0xD7A3 and (ord(res[-1]) - 0xAC00) % 28 == 0:
                    res[-1] = attach_jong(res[-1], batchim)
                else:
                    res.append('읏')
            else:
                res.append('스')
            ...
            i += 1
        elif text[i] in MONOGRAPHS:
            res.append(MONOGRAPHS[text[i]])
            i += 1
        else:
            res.append(text[i])
            i += 1
...
FIRST_NAMES = {
    ...
    "Joe": "조", "Joel": "조엘", "Joey": "조이", "John": "존", "Johnny": "조니", "Jon": "존", "Jonny": "조니",
    "Jonathan": "조나단", "Jordan": "조던", "Jorge": "호르헤", "Jose": "호세", "José": "호세", "Josh": "조시", "Joshua": "조슈아",
    "Josiah": "조사이어", "JP": "JP", "JT": "JT", "Juan": "후안", "Julian": "줄리안", "Julio": "훌리오",
    "Junior": "주니어", "Jurickson": "주릭슨", "Justin": "저스틴", "Justyn": "저스틴", "Keaton": "키튼", "Keider": "케이더", "Ken": "켄",
    "Kerry": "케리", "Ketel": "케텔", "Kevin": "케빈", "Kodai": "코다이", "Kumar": "쿠마", "Kutter": "커터", "Kyle": "카일",
...
LAST_NAMES = {
    ...
    "Curry": "커리", "Dana": "다나", "Darvish": "다르빗슈", "Davis": "데이비스", "De La Cruz": "데 라 크루즈", "DeLuca": "델루카",
    ...
    "Eflin": "에플린", "Elder": "엘더", "England": "잉글랜드", "Englert": "엥글러트", "Eovaldi": "이볼디", "Espada": "에스파다",
    ...
    "Lively": "라이블리", "Lodolo": "로돌로", "Lombard": "롬바드", "Long": "롱", "Lopez": "로페즈", "López": "로페즈",
    "Lorenzen": "로렌젠", "Lowder": "라우더", "Lowe": "로우", "Lugo": "루고", "Luzardo": "루자르도",
    "Lynn": "린", "Machado": "마차도", "Maeda": "마에다", "Mahle": "말리", "Malloy": "말로이", "Manaea": "마네아",
    "Marquez": "마르케스", "Marsh": "마쉬", "Marte": "마르테", "Martin": "마틴", "Martinez": "마르티네스",
    "Martínez": "마르티네스", "Mateo": "마테오", "Maton": "메이튼", "Matos": "마토스", "Matthews": "매튜스", "Matz": "마츠",
    "Mautz": "마우츠", "May": "메이", "Mays": "메이스", "McCarthy": "매카시", "McCaughan": "맥코건",
    "McClanahan": "맥클라나한", "McCullers": "맥컬러스", "McGough": "맥거프", "McGreevy": "맥그리비",
    "McLean": "맥클레인", "McMahon": "맥맨", "Meadows": "메도우스", "Megill": "메길", "Melton": "멜튼", "Menechino": "메네키노",
    "Merrill": "메릴", "Mesa": "메사", "Messick": "메식", "Meyer": "마이어", "Mey": "메이", "Mikolas": "마이콜라스",
    ...
    "Morgan": "모건", "Morris": "모리스", "Morton": "모튼", "Mullins": "멀린스", "Muncy": "먼시", "Munoz": "무뇨스",
...
STADIUM_MAP = {
    ...
    "ほっと神戸": "핫토못토 필드 고베",
    "ほっともっとフィールド神戸": "핫토못토 필드 고베",
    "みずほPayPay": "미즈호 PayPay 돔 후쿠오카",
    "みずほPayPayドーム福岡": "미즈호 PayPay 돔 후쿠오카",
    "マツダスタジアム": "마쓰다 스타디움",
    "MAZDA Zoom-Zoom スタジアム広島": "마쓰다 스타디움",
    "ハードオフ新潟": "하드오프 에코 스타디움 니가타",
    "HARD OFF ECOスタジアム新潟": "하드오프 에코 스타디움 니가타",
    "エスコンフィールド": "에스콘 필드 홋카이도",
    "ES CON FIELD HOKKAIDO": "에스콘 필드 홋카이도",
    "ベルーナドーム": "베루나 돔",
    "京セラドーム": "교세라 돔 오사카",
    "京セラドーム大阪": "교세라 돔 오사카",
    "バンテリンドーム": "반테린 돔 나고야",
...
def translate_stadium_name(raw: str) -> str:
    if not raw:
        return ""
    clean = sanitize_text(raw).strip()
    if clean in STADIUM_MAP:
        return STADIUM_MAP[clean]
    for k, v in STADIUM_MAP.items():
        if k in clean:
            return v
    if re.search(r'[\u3040-\u309F\u30A0-\u30FF]', clean):
        return katakana_to_hangul(clean)
    return clean
