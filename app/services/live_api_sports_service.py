...
KNOWN_PITCHER_SEASON_ERA: Dict[str, str] = {
    ...
    '모리시타': '2.25', '모리시타 마사토': '2.25', '森下': '2.25', '森下 暢仁': '2.25',
    '마타': '2.95', 'マタ': '2.95',
    ...
    '카타야마': '3.40', '야마구치': '3.50', '와타나베': '3.65', '마에다 유고': '3.10',
    '이시카와 슈타': '3.20', '이시카와': '3.20',

    # KBO 한국 프로야구 주요 선발 투수 시즌 방어율 (Official 2026/2025 기준)
    '류현진': '3.65', '원태인': '3.40', '양현종': '3.82', '곽빈': '3.95', '임찬규': '3.75',
    '김광현': '3.85', '고영표': '3.55', '하영민': '3.85', '신민혁': '3.90', '박세웅': '3.70',
    '최원태': '3.75', '시라카와': '4.10', '토다': '3.80', '소형준': '3.70', '김건우': '3.90',
    '최승용': '3.95', '엔스': '3.45', '네일': '2.53', '레예스': '3.81', '벤자민': '3.68',
    '쿠에바스': '3.85', '후라도': '2.68', '헤이수스': '3.42', '반즈': '3.05', '윌커슨': '3.48',
    '하트': '2.69', '카스타노': '3.72', '산체스': '3.88', '와이스': '3.73', '문동주': '3.95',
    '손주영': '3.79', '엄상백': '4.25', '이승현': '4.10', '이의리': '3.90', '윤영철': '4.15',
    '올러': '3.45', '배제성': '3.75', '라일리': '3.55', '아빌라': '3.60', '비슬리': '3.80',
    '박준현': '4.10', '박준영': '4.25', '황동하': '4.40', '최원준': '4.30', '엘리아스': '4.08',
    '송영진': '4.50', '김진욱': '4.35', '이재학': '4.40', '김인범': '4.20', '코너': '3.75',
    '페덱': '3.30', '에릭 페디': '3.30', '전준표': '4.60', '이준기': '4.80', '황준서': '4.45',
