...
TEAM_SYNONYMS = {
    ...
    "김포": ["김포", "김포fc", "김포 fc", "gimpo citizen", "gimpo fc"],
    "충북청주": ["충북청주", "충북청주 프로축구단", "충북청주fc"],
    "경남": ["경남", "경남fc", "경남 fc", "gyeongnam fc"],
    "대구": ["대구", "대구fc", "대구 fc"],
    "화성": ["화성", "화성fc", "화성 fc"],
    "서울이랜드": ["서울이랜드", "서울 이랜드", "서울이랜드fc"],
    "수원삼성": ["수원 삼성", "수원 삼성블루윙즈", "수원삼성"],
    "수원fc": ["수원fc", "수원 fc", "suwon fc"],
    "김해": ["김해", "김해fc", "김해시청", "김해fc 2008", "gimhae city"],
    "용인": ["용인", "용인fc", "용인시축구센터"],
    "부산": ["부산", "부산 아이파크", "부산아이파크", "busan i park", "busan ipark"],
    "전남": ["전남", "전남 드래곤즈", "전남드래곤즈", "jeonnam dragons"],
    "성남": ["성남", "성남fc", "성남 fc", "seongnam fc"],
    "천안": ["천안", "천안 시티", "천안시티fc", "천안 시티fc", "cheonan city"],
    "울산": ["울산", "울산 hd", "울산 현대"],
    ...
    # Soccer (J League)
    "교토상가": ["교토상가", "교토 상가", "kyoto sanga", "kyoto sanga fc"],
    "가시와": ["가시와", "가시와 레이솔", "kashiwa reysol", "kashiwa"],
    "비셀고베": ["비셀고베", "비셀 고베", "vissel kobe", "vissel"],
    "가시마": ["가시마", "가시마 앤틀러스", "kashima antlers", "kashima"],
    "도쿄베르디": ["도쿄베르디", "도쿄 베르디", "tokyo verdy"],
    "제프유나이티드": ["제프유나이티드", "제프 유나이티드", "jef united", "jef united chiba"],
    "베갈타센다이": ["베갈타 센다이", "vegalta sendai", "베갈타"],
    "삿포로": ["콘사도레 삿포로", "삿포로", "consadole sapporo"],
    "니가타": ["알비렉스 니가타", "니가타", "albirex niigata"],
    "야마가타": ["몬테디오 야마가타", "야마가타", "montedio yamagata"],
    "감바오사카": ["감바 오사카", "감바오사카", "gamba osaka"],
    "세레소오사카": ["세레소 오사카", "세레소오사카", "cerezo osaka"],
    "FC도쿄": ["fc도쿄", "fc 도쿄", "fc tokyo"],
    "나고야": ["나고야 그램퍼스", "나고야", "nagoya grampus"],
    "산프레체히로시마": ["산프레체 히로시마", "산프레체", "sanfrecce hiroshima"],
    "우라와": ["우라와 레즈", "우라와 레드 다이아몬즈", "urawa red diamonds", "urawa reds", "우라와"],
    "요코하마M": ["요코하마 f 마리노스", "요코하마 f. 마리노스", "요코하마 마리노스", "yokohama f marinos", "yokohama f. marinos"],
    "가와사키": ["가와사키 프론탈레", "가와사키", "kawasaki frontale"],

    # Soccer (Eredivisie)
    "트벤테": ["트벤테", "fc twente", "twente", "fc트벤테"],
    "덴하그": ["덴하그", "ado den haag", "ado 덴하흐", "ado덴하흐", "den haag", "덴하흐"],
    "엑셀시오르": ["엑셀시오르", "excelsior", "sbv excelsior"],
    "위트레흐트": ["위트레흐트", "fc utrecht", "utrecht", "fc위트레흐트"],
    "헤이렌베인": ["헤이렌베인", "heerenveen", "sc heerenveen"],
    "텔스타": ["텔스타", "telstar", "sc telstar"],
    "즈볼러": ["즈볼러", "pec zwolle", "zwolle", "pec즈볼러"],
    "페예노르트": ["페예노르트", "feyenoord", "feyenoord rotterdam"],
    "아약스": ["아약스", "ajax", "afc ajax"],
    "PSV": ["psv", "psv eindhoven", "psv에인트호번", "psv 에인트호번"],
    "AZ알크마르": ["az", "az alkmaar", "az 알크마르", "알크마르"],

    # Soccer (MLS)
    "마이애미": ["인터 마이애미", "인터마이애미", "마이애미", "inter miami", "inter miami cf"],
    "내슈빌SC": ["내슈빌", "내슈빌sc", "내슈빌 sc", "nashville sc", "nashville"],
    "콜럼버스": ["콜럼버스", "콜럼버스 크루", "columbus crew"],
    "NY레드불스": ["ny레드불스", "뉴욕 레드불스", "뉴욕레드불스", "new york red bulls", "ny red bulls"],
    "신시내티": ["신시내티", "fc 신시내티", "fc신시내티", "fc cincinnati", "cincinnati"],
    "샬럿FC": ["샬럿", "샬럿fc", "샬럿 fc", "charlotte fc", "charlotte"],
    "올랜도시티": ["올랜도", "올랜도시티", "올랜도 시티", "orlando city", "orlando city sc"],
    "토론토FC": ["토론토", "토론토fc", "토론토 fc", "toronto fc"],
    "DC유나이티드": ["dc유나이티드", "dc 유나이티드", "dc united"],
    "애틀랜타U": ["애틀랜타", "애틀랜타u", "애틀랜타 유나이티드", "atlanta united", "atlanta united fc"],
    "캔자스시티": ["캔자스시티", "스포팅 캔자스시티", "스포팅캔자스시티", "sporting kansas city"],
    "LAFC": ["lafc", "로스앤젤레스 fc", "로스앤젤레스 fc (lafc)", "los angeles fc"],
    "댈러스": ["댈러스", "fc 댈러스", "fc댈러스", "fc dallas"],
    "포틀랜드": ["포틀랜드", "포틀랜드 팀버즈", "portland timbers"],
    "세인트루이스C": ["세인트루이스", "세인트루이스c", "세인트루이스 시티", "st louis city sc", "st. louis city"],
    "미네소타U": ["미네소타", "미네소타u", "미네소타 유나이티드", "minnesota united", "minnesota united fc"],
    "솔트레이크": ["솔트레이크", "레알 솔트레이크", "real salt lake"],
    "NY시티FC": ["ny시티fc", "뉴욕 시티 fc", "뉴욕시티fc", "new york city fc", "ny city fc"],
    "콜로라도": ["콜로라도", "콜로라도 래피즈", "colorado rapids"],
    "몬트리올": ["몬트리올", "cf 몬트리올", "cf몽레알", "cf montreal", "montreal"],
    "LA갤럭시": ["la갤럭시", "la 갤럭시", "la galaxy"],
    "시애틀사운더스": ["시애틀", "시애틀사운더스", "시애틀 사운더스", "seattle sounders", "seattle sounders fc"],
    "새너제이": ["새너제이", "산호세 어스퀘이크스", "san jose earthquakes"],
    "휴스턴다이나모": ["휴스턴", "휴스턴다이나모", "휴스턴 다이나모", "houston dynamo", "houston dynamo fc"],

    # Soccer (Championship)
    "사우샘프턴": ["사우샘프턴", "사우샘프", "southampton", "southampton fc"],
    "브리스톨시티": ["브리스틀 시티", "브리스톨 시티", "브리스톨시티", "bristol city"],
    "셰필드U": ["셰필드 유나이티드", "셰필드유나이티드", "sheffield united", "sheffield utd"],
    "울버햄튼": ["울버햄튼 원더러스", "울버햄튼", "wolverhampton wanderers", "wolverhampton", "wolves"],
    "블랙번": ["블랙번 로버스", "블랙번", "blackburn rovers", "blackburn"],
    "밀월": ["밀월", "millwall", "millwall fc"],
    "찰턴": ["찰턴 애슬레틱", "찰턴", "charlton athletic", "charlton"],
    "포츠머스": ["포츠머스", "portsmouth", "portsmouth fc"],
    "미들즈브러": ["미들즈브러", "middlesbrough", "middlesbrough fc"],
    "노리치": ["노리치 시티", "노리치", "norwich city", "norwich"],
    "프레스턴": ["프레스턴 노스 엔드", "프레스턴", "preston north end", "preston"],
    "링컨시티": ["링컨 시티", "링컨", "lincoln city"],
    "스완지": ["스완지 시티", "스완지", "swansea city", "swansea"],
    "번리": ["번리", "burnley", "burnley fc"],
    "왓포드": ["왓포드", "watford", "watford fc"],
    ...
    def get_indexed_proto_matches(force_refresh: bool = False) -> dict:
        ...
        for r in datas:
            ...
            odd_item = {
                'seq': seq,
                'bet_id': d.get('betId'),
                'bet_name': d.get('betNm') or d.get('betTypNm', '일반'),
                'type': d.get('betTypNm', '일반'),
                'handicap': str(handi_val) if handi_val not in (None, '', 0, 0.0) else '',
                'uo': str(handi_val) if handi_val not in (None, '', 0, 0.0) else '',
                'home_odds': w_allot,
                'draw_odds': d_allot,
                'away_odds': l_allot,
                'win_txt': d.get('winTxt', '승'),
                'draw_txt': d.get('drawTxt', '-'),
                'lose_txt': d.get('loseTxt', '패'),
                'game_result': d.get('gameResult'),
                'mch_score': d.get('mchScore'),
