...
<head>
  <meta charset="UTF-8">
  <title>[공식 MLB 실시간 결과] [홈] {m['home_team_name']} vs [원정] {m['away_team_name']}</title>
    ...
    <div class="container">
      <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
        <div>
          ...
          <h2 class="fw-bold mb-1"><i class="bi bi-trophy-fill text-warning me-2"></i>[홈] {m['home_team_name']} vs [원정] {m['away_team_name']}</h2>
    ...
    <div class="card border-0 shadow-sm mb-4">
      <div class="card-body p-4 text-center">
        <div class="row align-items-center">
          ...
          <div class="col-auto">
            <div class="badge bg-dark text-white score-badge px-4 py-2 shadow">{m['home_score']} : {m['away_score']}</div>
