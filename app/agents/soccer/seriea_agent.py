"""
TOKEON 이탈리아 세리에 A (Serie A) 전담 데이터 수집 & 검증 관리 에이전트 (SerieAAgent)
- 전담 리그: 이탈리아 세리에 A (Serie A) (League ID: 135)
...
class SerieAAgent(BaseSoccerLeagueAgent):
    def __init__(self):
        super().__init__(
            league_id=135,
            league_name="이탈리아 세리에 A (Serie A)",
            league_code="SERIE_A"
        )
