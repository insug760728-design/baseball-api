"""
TOKEON 프랑스 리그 1 (Ligue 1) 전담 데이터 수집 & 검증 관리 에이전트 (Ligue1Agent)
- 전담 리그: 프랑스 리그 1 (Ligue 1) (League ID: 61)
...
class Ligue1Agent(BaseSoccerLeagueAgent):
    def __init__(self):
        super().__init__(
            league_id=61,
            league_name="프랑스 리그 1 (Ligue 1)",
            league_code="LIGUE_1"
        )
