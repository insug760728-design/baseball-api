"""
TOKEON 남미 코파 리베르타도레스 (Copa Libertadores) 전담 데이터 수집 & 검증 관리 에이전트 (CopaAgent)
- 전담 리그: 남미 코파 리베르타도레스 (Copa Libertadores) (League ID: 13)
...
class CopaAgent(BaseSoccerLeagueAgent):
    def __init__(self):
        super().__init__(
            league_id=13,
            league_name="남미 코파 리베르타도레스 (Copa Libertadores)",
            league_code="COPA"
        )
