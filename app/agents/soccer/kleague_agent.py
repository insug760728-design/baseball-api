"""
TOKEON K리그 1 (K-League) 전담 데이터 수집 & 검증 관리 에이전트 (KLeagueAgent)
- 전담 리그: K리그 1 (K-League) (League ID: 292)
...
class KLeagueAgent(BaseSoccerLeagueAgent):
    def __init__(self):
        super().__init__(
            league_id=292,
            league_name="K리그 1 (K-League)",
