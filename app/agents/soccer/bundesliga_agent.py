"""
TOKEON 독일 분데스리가 (Bundesliga) 전담 데이터 수집 & 검증 관리 에이전트 (BundesligaAgent)
- 전담 리그: 독일 분데스리가 (Bundesliga) (League ID: 78)
...
class BundesligaAgent(BaseSoccerLeagueAgent):
    def __init__(self):
        super().__init__(
            league_id=78,
            league_name="독일 분데스리가 (Bundesliga)",
