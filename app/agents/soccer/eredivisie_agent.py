"""
TOKEON 네덜란드 에레디비시 (Eredivisie) 전담 데이터 수집 & 검증 관리 에이전트 (EredivisieAgent)
- 전담 리그: 네덜란드 에레디비시 (Eredivisie) (League ID: 88)
...
class EredivisieAgent(BaseSoccerLeagueAgent):
    def __init__(self):
        super().__init__(
            league_id=88,
            league_name="네덜란드 에레디비시 (Eredivisie)",
