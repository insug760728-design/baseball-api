"""
TOKEON 스페인 라리가 (La Liga) 전담 데이터 수집 & 검증 관리 에이전트 (LaLigaAgent)
- 전담 리그: 스페인 라리가 (La Liga) (League ID: 140)
...
class LaLigaAgent(BaseSoccerLeagueAgent):
    def __init__(self):
        super().__init__(
            league_id=140,
            league_name="스페인 라리가 (La Liga)",
            league_code="LALIGA"
        )
